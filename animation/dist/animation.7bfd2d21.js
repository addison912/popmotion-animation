...
},{"hey-listen":"node_modules/hey-listen/dist/hey-listen.es.js","process":"../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/style-value-types/dist/style-value-types.es.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/@popmotion/easing/dist/easing.es.js":[function(require,module,exports) {
"use strict";
...
var blendColor = function (from, to) {
  ...
  var blendFunc = from.hue !== undefined || typeof from === 'string' && styleValueTypes.hsla.test(from) ? getValueFromProgress : blend;
  return function (v) {
...
var nonlinearSpring =
/*#__PURE__*/
generateStaticSpring(Math.sqrt);
...
var createColorAction = function (action, _a) {
  ...
  return action((0, _tslib.__assign)({}, props, {
    from: 0,
    to: 1
  })).pipe(blendColor(from, to), styleValueTypes.color.transform);
};
...
var createComplexAction = function (action, _a) {
  ...
  return action((0, _tslib.__assign)({}, props, {
    from: 0,
    to: 1
  })).pipe(blendArray(styleValueTypes.complex.parse(from), styleValueTypes.complex.parse(to)), valueTemplate);
};
